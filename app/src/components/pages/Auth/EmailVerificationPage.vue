...
<template>
  <div class="bg-grey-lighter min-h-screen flex flex-col">
    <div
      v-if="isShow && verifyEmailSuccess"
      class="container max-w-2xl mx-auto flex-1 flex flex-col items-center justify-start mt-20 px-2"
      style="width: 60%"
    >
      <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full">
        ...
        <div class="text-center">
          <router-link
            class="w-44 inline-block text-center py-3 rounded bg-blue-700 text-white hover:bg-blue-500 focus:outline-none my-1"
            to="/login"
          >
            ログイン画面へ
          </router-link>
    ...
    <div
      v-else-if="isShow && !verifyEmailSuccess"
      class="container max-w-2xl mx-auto flex-1 flex flex-col items-center justify-start mt-20 px-2"
      style="width: 60%"
    >
      <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full">
